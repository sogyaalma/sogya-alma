...
import { directorsBoardMembers } from "../../../interfaces/Founding.members";
...
const DirectorsBoard = () => {
  return (
    <>
      {" "}
      <PageContainer
        title="جمعية غيث - مجلس الإدارة"
        description="مجلس الإدارة"
      >
        <NavBar variant="homePage" />
        <div className="ghaith--projects-page" style={{ marginTop: "9rem" }}>
          <div className="ghaith--newsSection-title">
            <h1>
              <span className="ghaith--donation-highlight">مجلس </span>
              <span className="ghaith--donation-primary">الإدارة</span>
            </h1>
          </div>
          ...
          <div className="ghaith--founding-members-container">
            <Row
              ...
              style={{ direction: "rtl" }}
            >
              {directorsBoardMembers.map((member) => (
                <Col
                  key={member.id}
                  xs={24}
                  sm={12}
