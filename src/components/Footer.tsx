...
export default function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 pt-16 pb-8 border-t-4 border-primary transition-colors duration-300">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-6">
            <Link href="/" className="flex items-center gap-3 group">
              <img 
                ...
                className="h-[60px] md:h-[75px] w-auto transition-transform group-hover:scale-105" 
              />
            </Link>
          ...
          {/* About & Governance */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-secondary dark:text-white border-r-2 border-primary pr-3">الجمعية والحوكمة</h4>
          ...
          {/* Projects */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-secondary dark:text-white border-r-2 border-primary pr-3">مشاريعنا</h4>
            <ul className="flex flex-col gap-3 text-gray-600 dark:text-gray-400 text-sm">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-secondary dark:text-white border-r-2 border-primary pr-3">تواصل معنا</h4>
            <ul className="flex flex-col gap-4 text-gray-600 dark:text-gray-400 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:0112766744" className="hover:text-primary transition-colors font-mono font-bold">0112766744</a>
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="mt-6 flex gap-3">
              <Link href="/volunteer" className="bg-primary hover:bg-primary-dark text-white text-xs font-bold px-4 py-2 rounded-lg transition-colors shadow-sm">
                تطوع معنا
              </Link>
              <Link href="/contact" className="bg-white dark:bg-white/10 hover:bg-gray-100 dark:hover:bg-white/20 text-secondary dark:text-white border border-gray-200 dark:border-transparent text-xs font-bold px-4 py-2 rounded-lg transition-colors shadow-sm">
                اتصل بنا
              </Link>
            </div>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-500 dark:text-gray-500 text-sm">
          ...
          <div className="flex gap-6">
            <Link href="/about/privacy" className="hover:text-primary transition-colors font-medium">سياسة الخصوصية</Link>
            <Link href="/about/terms" className="hover:text-primary transition-colors font-medium">شروط الاستخدام</Link>
            <Link href="/contact" className="hover:text-primary transition-colors font-medium">اتصل بنا</Link>
          </div>
        </div>
