...
import ReportCard from "../../donor/reports/ReportsAttachment";
import { getBeneficiaryReports } from "../../../../apis/actions/beneficiary.actions";
...
const ReportsComponent: React.FC<ReportsProps> = ({ limit }) => {
  ...
  const { data: reports, loading } = useSelector(
    (state: RootState) => state?.beneficiary.beneficiaryReports
  );
  const { TotalbeneficiaryReports } = useSelector(
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="ghaith--pagination-container">
              {reports &&
                Math.ceil(TotalbeneficiaryReports) * itemPerPage >
                  itemPerPage && (
                  <PaginationComponent
                    active={currentPage}
                    total={Math.ceil(TotalbeneficiaryReports) * itemPerPage}
