...
import { CeoInformations } from "../../../interfaces/Founding.members";
...
const CeoPage = () => {
  return (
    <>
      {" "}
      <PageContainer
        title="جمعية غيث - المدير التنفيذي"
      ...
      >
        ...
        <div className="ghaith--projects-page" style={{ marginTop: "9rem" }}>
          <div className="ghaith--newsSection-title">
            <h1>
              <span className="ghaith--donation-highlight">المدير </span>
              <span className="ghaith--donation-primary">التنفيذي</span>
            </h1>
          </div>
