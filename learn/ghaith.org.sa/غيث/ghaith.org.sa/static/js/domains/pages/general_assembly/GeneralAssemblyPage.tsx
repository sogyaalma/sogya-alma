...
import { GeneralAssemblymember } from "../../../interfaces/Founding.members";
...
const GeneralAssemblyPage = () => {
  return (
    <>
      {" "}
      <PageContainer
        title="جمعية غيث - أعضاء الجمعية العمومية"
        description="أعضاء الجمعية العمومية"
      >
        <NavBar variant="homePage" />
        <div className="ghaith--projects-page" style={{ marginTop: "9rem" }}>
          <div className="ghaith--newsSection-title">
            <h1>
              <span className="ghaith--donation-highlight">أعضاء </span>
              <span className="ghaith--donation-primary">الجمعية العمومية</span>
            </h1>
          </div>
          ...
          <div className="ghaith--founding-members-container">
            <Row
              ...
              style={{ direction: "rtl" }}
            >
              {GeneralAssemblymember.map((member) => (
                <Col
                  key={member.id}
                  xs={24}
                  sm={12}
